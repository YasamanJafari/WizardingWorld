...
public class Professor extends Person{
	...
	//constructor
	public Professor(Map<Integer, Course> courses, String notes, String name, House houseName, BloodStatus bloodStatus, String school, Date birthday){
		//calling the parent's constructor
		super(name, houseName, bloodStatus, school, birthday);
		_courses = courses;
		_notes = notes;
	}
	public Professor(Map<Integer, Course> courses, String name, House houseName, BloodStatus bloodStatus, String school, Date birthday){
		//if notes is not given
		this(courses, "", name, houseName, bloodStatus, school, birthday);
	}
	public Professor(String notes, String name, House houseName, BloodStatus bloodStatus, String school, Date birthday){
		//if courses is not given
		this(null, notes, name, houseName, bloodStatus, school, birthday);
	}
	public Professor(String name, House houseName, BloodStatus bloodStatus, String school, Date birthday){
